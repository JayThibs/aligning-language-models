...
def create_csv(jsonl, args):
    ...
    print(len(all_sequences_across_epochs))
    print(len(all_sequences_across_epochs[-1]))
...
if __name__ == "__main__":
    ...
    input_folder = Path(str(args.input_path).split(".jsonl")[0] + "_txt_folder")
